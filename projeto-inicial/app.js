...
while (palpite != numeroSecreto) {
  ...
  // fora do if/else pois se chegou até aqui é porque ele tentou e não acertou, já que, se tivesse, teria caido no break e o código teria se encerrado sem chegar até aqui
  tentativas++;
}